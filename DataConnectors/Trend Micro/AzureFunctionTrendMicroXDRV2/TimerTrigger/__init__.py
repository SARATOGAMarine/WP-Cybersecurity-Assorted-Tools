...
logging.info("Input regioncode: ".format(regioncode))
logging.info("url base: ".format(url_base))
...
def getWorkbenchList():
    ...
    logging.info("Getting workbenchList from: ".format(url))
...
def getWorkbench(workbenchIds):
    ...
    headers = {'Authorization': 'Bearer ' + api_id, 'Content-Type': 'application/json;charset=utf-8'}
    logging.info("Getting workbench data of id: {} from: ".format(workbenchIds,url))
