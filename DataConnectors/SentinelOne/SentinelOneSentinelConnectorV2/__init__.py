...
logging.info("Input URl: ".format(domain))
...
class SOne():
    ...
    def auth(self):
        ...
        logging.info("Logging in through url: {}".format(self.domain + endpoint))
        logging.info("Username: {}".format(self.user))
        logging.info("Password: {}".format(self.passwd))
    ...
    def get_report(self, report_type_suffix, next_page_token = None, params = None):
        ...
        try:
            logging.info("Getting reports from URL: {}".format(self.domain + report_type_suffix))
...
def main(mytimer: func.TimerRequest) -> None:
    ...
    logging.info("Results Count: {}".format(len(results_array)))
